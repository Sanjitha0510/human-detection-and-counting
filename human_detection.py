...
def detect_by_input(input_type, input_path, model, layer_name):
    output_folder = "C:\\Users\\roope\\OneDrive\\Desktop\\DSA PROJ"  # Set the default output folder
    ...
    if input_type == "image":
        ...
        results = human_detection(image, model, layer_name, personidz=LABELS.index("person"))
        ...
        while True:
            ...
            if not grabbed:
                break
            image = imutils.resize(image, width=700)
            human_detection(image, model, layer_name, personidz=LABELS.index("person"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default='C:\\Users\\roope\\OneDrive\\Desktop\\DSA PROJ\\test1.jpg', help='Path to input file (image, video) or camera index (webcam)')
